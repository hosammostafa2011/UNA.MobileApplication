...
namespace UNA.MobileApplication.Views
{
    ...
    public partial class SearchPage : ContentPage
    {
        ...
        public SearchPage(string categoryID, string categoryName, string nationID)
        {
            InitializeComponent();
            try
            {
            ...
            txtSearch.Placeholder = categoryName;
            BindingContext = _newsListViewModel = new NewsListViewModel("1700", categoryName, string.Empty);
        }
        ...
        /*protected override void OnAppearing()
        {
            ...
            _newsListViewModel.LoadNewsCommand.Execute("1700");
        }*/
        ...
        {
            _newsListViewModel.SEARCH_TEXT = txtSearch.Text;
            _newsListViewModel.LoadNewsCommand.Execute(txtSearch.Text);
        }
    }
}